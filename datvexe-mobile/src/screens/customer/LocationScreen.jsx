  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log(response.data[0].benXe);
        console.log(response.data[1].benXe);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <ActionSheetLocation
          actionSheetRefLocation={actionSheetRefLocation}
        ...
        <ActionSheetPickPassenger
          actionSheetPassenger={actionSheetPassenger}
