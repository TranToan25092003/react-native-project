...
const ActionSheetLocation = ({
  actionSheetRefLocation,
  currentLocationType,
  dataLocation,
  selectLocation,
}) => {
  const renderLocationItem = ({ item }) => {
    return (
      <View>
        <Text style={styles.cityHeader}>{item.tenTinh ?? "choose city"}</Text>
  ...
  return (
    <ActionSheet ref={actionSheetRefLocation} gestureEnabled={true}>
      <View style={{ height: 300 }}>
        {" "}
        {/* Thêm chiều cao để đảm bảo hiển thị */}
